### Infinite Love Loop Simulation Script
...
class LoveSimulation:
    ...
    def run (self, auto=False):
        while True:
            ...
            choice = get_user_choice (options, auto=auto)
...
def get_user_choice (options, auto=False):
    if auto:
...
# Ask the user if they want to enable auto-simulation
auto_simulation = input ("Do you want to enable auto-simulation? (yes/no): ").strip ().lower () == "yes"

# Run the simulation with the user's choice
simulation.run (auto=auto_simulation)